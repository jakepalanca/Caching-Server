...
class CryptoCacheFunctionalTest {
    ...
    public void testFetchTopCoinsWithCorrectProperties() throws IOException, ParseException, org.apache.hc.core5.http.ParseException {
        ...
        mockCoin.setPriceChange24hInCurrency(100.0);
        ...
        mockCoin.setMarketCapChange24hInCurrency(10000000L);
        ...
        assertThat(coin.getPriceChange24hInCurrency()).isEqualTo(100.0);
        ...
        assertThat(coin.getMarketCapChange24hInCurrency()).isEqualTo(10000000L);
